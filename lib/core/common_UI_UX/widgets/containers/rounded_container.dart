...
class BitLuxRoundedContainer extends StatelessWidget {
  ...
  const BitLuxRoundedContainer({
    ...
    this.padding = const EdgeInsets.all(BitLuxSizes.sm),
    this.borderColor = BitLuxColors.borderPrimary,
    this.radius = BitLuxSizes.cardRadiusLg,
    this.backgroundColor = BitLuxColors.secondary,
    this.onTap,
  });
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          //   if (showShadow)
          //     BoxShadow(
          //       color: BitLuxColors.grey.withOpacity(0.1),
          //       spreadRadius: 5,
          //       blurRadius: 8,
